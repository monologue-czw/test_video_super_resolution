...
from models_video.RAFT.raft_bi import RAFT_bi    #估计光流
...
if __name__ == '__main__':
    ...
    for i, video_path in enumerate(video_list):
        ...
        prompt = video_caption + args.a_prompt        #llava生成的加上自己输入的
